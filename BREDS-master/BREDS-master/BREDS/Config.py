...
class Config(object):
    ...
    def __init__(self, config_file, positive_seeds, negative_seeds,
        ...
        #https://docs.python.org/3/howto/regex.html  regex charachter interpretation like:[^5] all chars except 5..
        # linked tags e.g.:
    ...
    def read_word2vec(self):
       ...
       # print("Vahab_sample similarity(Silvio Berlusconi ,Italian)=" ,self.word2vec.similarity("Silvio Berlusconi","Italian"))
